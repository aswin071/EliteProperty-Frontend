...
export function VendorRegistration() {
    ...
    const [brokerage_fee, setBrokerage_fee] = useState('');
    ...
    const route = `/vendors/vendor-createprofile/${userId}/`;
    ...
    const handleRegisterProfile = async () => {
        ...
        formData.append('brokerage_fee', brokerage_fee);
                ...
                <div className="flex flex-1 flex-col items-center justify-center px-10 relative">
                    ...
                    <div className="flex flex-1 flex-col justify-center space-y-5 max-w-md">
                        <div className="flex flex-col space-y-2 text-center">
                            <h2 className="text-3xl md:text-4xl font-bold">Register as Vendor</h2>
                        ...
                        <div className="flex flex-col max-w-md space-y-5">
                            ...
                            <input
                                type="text"
                                placeholder="Brokerage_fee"
                                value={brokerage_fee}
                                onChange={(e) => setBrokerage_fee(e.target.value)}
                                className="flex px-3 py-2 md:px-4 md:py-3 border-2 border-black rounded-lg font-medium placeholder:font-normal"
                            />
